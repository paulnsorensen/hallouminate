...
| Advisory (must **not** fail the eval) | `code-repos-empty`, `cross-repo-union` | `hallouminate-domain/src/ground/format.rs:334,368`, `hallouminate-daemon/src/dispatch.rs:444` |
