...
Supported platforms: macOS (Apple Silicon, arm64), Linux (x64 / arm64,
glibc). For Intel macOS, Windows, musl Linux, or other targets, install
from source with `cargo install hallouminate`.
