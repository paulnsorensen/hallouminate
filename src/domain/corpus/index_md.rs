...
//! without them.
//!
//! The list inside the markers is generated from a single readdir per
//! ancestor directory plus a cheap H1 sniff per child markdown file. It
//! lists immediate-child markdown files first (excluding `index.md` itself)
//! and immediate-child subdirectories that themselves contain markdown.
//! That gives a consumer LLM a navigable tree without having to ground or
//! list_files; an author LLM can use it as a hand-off summary of what's in
//! the corpus.
