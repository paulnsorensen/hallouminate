...
use crate::domain::search::{search, Fusion};
...
mod tests {
    ...
    use super::*;
    use crate::adapters::sqlite::apply_schema;
    use crate::adapters::sqlite::open_db;
    use crate::adapters::sqlite::{insert_chunk, insert_vec, upsert_file, NewChunk, NewFile};
    ...
    fn seed_chunk(conn: &DbConn, s: &Seed<'_>) -> i64 {
